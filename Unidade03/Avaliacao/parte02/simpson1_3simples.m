...
% Número de subintervalos (N deve ser ímpar para Simpson)
N = 1000; 
if mod(N, 2) ~= 0
...
% Integral usando o método de Simpson 1/3
h = r(2) - r(1); % Tamanho do passo

% Calculando a integral usando a fórmula de Simpson
...
fprintf('Velocidade média (numericamente - Simpson 1/3): %.6f m/s\n', v_media_numeric);
