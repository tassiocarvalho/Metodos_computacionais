function h = secante()
    ...
    % Vetor para armazenar raízes aproximadas
    raizes_aprox = [];
    ...
    while erro_aproximado > tol
        ...
        % Armazenar a raiz aproximada para plotagem
        raizes_aprox = [raizes_aprox xr];
        
        % Imprimir os resultados na tabela
        fprintf('%-12d %-22.8f %-22.8f %-20.8f %-22.8f\n', iter, xr, g(xr), erro_aproximado, abs((xr - h_real) / h_real) * 100);
